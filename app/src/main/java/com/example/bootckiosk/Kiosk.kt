...
//                flag = 1
    ...
    private fun initData(): ArrayList<ShakeshackMenu>{
        ...
        val chickens = arrayListOf<ShakeshackMenu>(
            Chicken(1,"핫 치킨", "바삭하고 두툼한 치킨 통살과 스파이시 슬로, 핫 스파이시 시즈닝이 토핑된 치킨 버거 (닭가슴살/닭다리살 선택 가능)",9500,"Chicken"),
            Chicken(2,"치킨쉑", "바삭하고 두툼한 치킨 통살과 양상추, 피클, 허브 마요 소스가 토핑된 치킨 버거 (닭가슴살/닭다리살 선택 가능)",8000, "Chicken" ),
            Chicken(3,"치킨 바이트", "한 입에 먹기 좋은 바삭한 치킨 바이트와 허니 머스터드 또는 BBQ 소스를 선택하여 함께 즐기는 메뉴",5900 ,"Chicken"),
        )
        all.addAll(menu)
        all.addAll(burgers)
        all.addAll(drinks)
